...
public class ValidationChecker {
    ...
    public void isValid(String value) {
        ...
        assertTrue(String.format("%s is not valid for annotation %s", value, annotation.toString()),
                validator.isValid(value, null));
    }

    public void isNotValid(String value) {
        assertThat(value, doesNotMatchRegexp(pattern));
        assertFalse(String.format("%s should not be valid for annotation %s", value, annotation.toString()),
                validator.isValid(value, null));
    }
}
